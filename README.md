...
* `com.thinkincode.utils.database.QueryPlanExplainer` – Contains helper methods for explaining the query plan of queries in a given database.
...
Secondly and finally, you need to declare the library as a dependency in your app. You can do this by copying the following declaration into the `build.gradle` file of your app:
    ...
    dependencies {
        compile 'com.thinkincode.utils:Android:0.1.2'
    }
