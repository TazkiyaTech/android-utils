...
/**
 * An implementation of the {@link View.OnTouchListener} interface that simply reports
 * (1) when a {@link View} is touched down and either
 * (2) when the down touch is released on the {@link View} or
 * (3) when the down touch is canceled
